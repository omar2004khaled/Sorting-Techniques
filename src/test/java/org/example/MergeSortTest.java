...
public class MergeSortTest {
    ...
    public void testMergeSortSortedArray() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortSortedArray took " + (endTime - startTime) + " ns");
    ...
    public void testMergeSortReverseSortedArray() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortReverseSortedArray took " + (endTime - startTime) + " ns");
        assertArrayEquals(new int[]{1, 2, 3, 4, 5}, result.get(0));
    }
    ...
    public void testMergeSortAllSameElements() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortAllSameElements took " + (endTime - startTime) + " ns");
    ...
    public void testMergeSortSingleElement() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortSingleElement took " + (endTime - startTime) + " ns");
    ...
    public void testMergeSortTwoElementsSorted() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortTwoElementsSorted took " + (endTime - startTime) + " ns");
    ...
    public void testMergeSortTwoElementsUnsorted() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortTwoElementsUnsorted took " + (endTime - startTime) + " ns");
        assertArrayEquals(new int[]{1, 2}, result.get(0));
    }
    ...
    public void testMergeSortLargeNumbers() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortLargeNumbers took " + (endTime - startTime) + " ns");
    ...
    public void testMergeSortNegativeNumbers() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortNegativeNumbers took " + (endTime - startTime) + " ns");
    ...
    public void testMergeSortMixedNumbers() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortMixedNumbers took " + (endTime - startTime) + " ns");
    ...
    public void testMergeSortArrayWithZero() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortArrayWithZero took " + (endTime - startTime) + " ns");
    ...
    public void testMergeSortArrayWithDuplicates() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortArrayWithDuplicates took " + (endTime - startTime) + " ns");
    ...
    public void testMergeSortAlreadySortedArray() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortAlreadySortedArray took " + (endTime - startTime) + " ns");
    ...
    public void testMergeSortDescendingArray() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortDescendingArray took " + (endTime - startTime) + " ns");
    ...
    public void testMergeSortAlternatingNumbers() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortAlternatingNumbers took " + (endTime - startTime) + " ns");
        assertArrayEquals(new int[]{1, 2, 3, 4, 5}, result.get(0));
    }
    ...
    public void testMergeSortLargeArray() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortLargeArray took " + (endTime - startTime) + " ns");
    ...
    public void testMergeSortArrayContainingMaxMinInteger() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortArrayContainingMaxMinInteger took " + (endTime - startTime) + " ns");
    ...
    public void testMergeSortArrayWithOneNegativeAtEnd() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortArrayWithOneNegativeAtEnd took " + (endTime - startTime) + " ns");
    ...
    public void testMergeSortEmptyArray() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortEmptyArray took " + (endTime - startTime) + " ns");
    ...
    public void testMergeSortVeryLargeNumbers() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortVeryLargeNumbers took " + (endTime - startTime) + " ns");
    ...
    public void testMergeSortArrayWithRepeatedPatterns() {
        ...
        ArrayList<int[]> result = sortArray.MergeSort(false);
        long endTime = System.nanoTime();
        System.out.println("testMergeSortArrayWithRepeatedPatterns took " + (endTime - startTime) + " ns");
